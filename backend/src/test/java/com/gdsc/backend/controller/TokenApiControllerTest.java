...
import com.gdsc.backend.config.jwt.JwtFactory;
import com.gdsc.backend.config.jwt.JwtProperties;
...
class TokenProviderTest {
    ...
    void generateToken() {
        ...
        SiteUser testUser = userRepository.save(SiteUser.builder()
                ...
                .password("test")
                .email("test@example.com").birthDate(LocalDate.of(2000, 1, 1))
                .name("동동").nickname("ehsf").profileImage("sidjflsf")
                .build());
